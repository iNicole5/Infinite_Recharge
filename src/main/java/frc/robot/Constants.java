...
public final class Constants {
    ...
    public static final class ShooterConstrants {
        public static final int shooterMotorMaster = 14; 
        public static final int shooterMotorSlave = 13;
    ...
    public static final class IntakeConstrants {
        ...
        public static final int ballStorageMotor = 8; 
    }

    public static final class ClimberConstrants {
        public static final int irrectionmotor = 9;     //VictorSPX
        public static final int hookLeveler = 10;       //VictorSPX
